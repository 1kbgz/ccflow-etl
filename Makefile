...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_etl
	python -m ruff format ccflow_etl
...
test:  ## run python tests
	python -m pytest -v ccflow_etl/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_etl/tests --cov=ccflow_etl --cov-report term-missing --cov-report xml
